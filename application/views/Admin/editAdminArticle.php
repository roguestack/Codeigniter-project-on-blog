...
<div class="container-fluid">
	<div class="mt-3" style="display: flex;justify-content:space-between">
		<h1 class="text-center">Admin | Edit Article</h1>
		<div>
...
<div class="form-group">
      ...
      <?php echo form_input(['name'=>'article_title','class'=>'form-control','type'=>'text','placeholder'=>'Article Title','value'=>set_value('article_title',$article->article_title)]) ?>
...
<div class="form-group">
	  ...
	  <?php echo form_textarea(['name'=>'article_body','class'=>'form-control','type'=>'textarea','rows'=>10,'placeholder'=>'Article Details','value'=>set_value('article_body',$article->article_body)]) ?>
